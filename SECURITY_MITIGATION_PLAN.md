...
| M4 — CLI proves real TEE | PARTIAL | Phase 5 code path, REPORT_DATA binding, and the live CLI sensitive-payload path now use attestation-pinned TLS and receipt-key binding. Still blocked on bundled platform-release anchors, full raw AMD SNP report/VCEK validation, keyring UX completion, and broader production rollout beyond cap-test01. |
